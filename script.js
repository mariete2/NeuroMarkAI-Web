...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- NOTA IMPORTANTE ---------- */
  // La sección de navegación suave ha sido eliminada de este archivo
  // para evitar redundancia con el código ya existente en los archivos HTML.
  // Mantener la lógica de navegación en un solo lugar previene conflictos
